...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.pushButton_2.clicked.connect(self.get_needle_distance)   ##按钮响应
        self.pushButton.clicked.connect(self.get_time)

    def retranslateUi(self, Dialog):
        _translate = QtCore.QCoreApplication.translate
        Dialog.setWindowTitle(_translate("Dialog", "Dialog"))
        self.label.setText(_translate("Dialog", "超声影像地址"))
        self.label_2.setText(_translate("Dialog", "肿瘤大小（cm）"))
        self.label_3.setText(_translate("Dialog", "功率（W）："))
        self.label_4.setText(_translate("Dialog", "针距（cm）："))
        self.label_5.setText(_translate("Dialog", "针型："))
        self.label_6.setText(_translate("Dialog", "FIB4  ："))
        self.label_7.setText(_translate("Dialog", "微波消融热场参数规划"))
        self.comboBox_2.setItemText(0, _translate("Dialog", "1型"))
        self.comboBox_2.setItemText(1, _translate("Dialog", "2型"))
        self.pushButton.setText(_translate("Dialog", "获取消融时间"))
        self.label_8.setText(_translate("Dialog", "时间(s)："))
        ...
        self.pushButton_2.setText(_translate("Dialog", "获取针距"))
        self.label_13.setText(_translate("Dialog", "重要毗邻结构导致："))
        self.comboBox_3.setItemText(0, _translate("Dialog", "热量流失"))
        self.comboBox_3.setItemText(1, _translate("Dialog", "正常"))
        self.comboBox_3.setItemText(2, _translate("Dialog", "热量聚集"))
    ...
    def get_time(self):
        ...
        if flag == 0:  ##数据读取通过
            ...
            norm = [3.7, 3.4, 3.1, 60., 2., 1.8, 1., 22.57]
            input = input / norm
